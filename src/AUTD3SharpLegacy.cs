...
{
    using Base = NativeMethods.BaseLegacy;

    internal class AUTDControllerHandleLegacy : SafeHandleZeroOrMinusOneIsInvalid
    {
        internal IntPtr CntPtr => handle;

        public AUTDControllerHandleLegacy(bool ownsHandle) : base(ownsHandle)
        {
            handle = new IntPtr();
    ...
    {
        public CustomGain(double[] amp, double[] phase) : base()
        {
    ...
    {
        public SineLegacy(int freq, double amp = 1.0, double offset = 0.5) : base()
        {
    ...
    {
        public CustomModulation(byte[] data, uint freqDiv) : base()
        {
